...
public class WatchController {
	private static Watch selectedWatch;

	public static Watch getSelectedWatchInTable() {
		return selectedWatch;
	}

	public static void setSelectedWatchInTable(Watch selectedWatch) {
		WatchController.selectedWatch = selectedWatch;
	}

	public static void clearSelectedWatch() {
		WatchController.selectedWatch = null;
	}

	public static boolean isSelectedWatch() {
		return selectedWatch == null ? false : true;
	}
