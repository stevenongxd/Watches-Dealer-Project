...
public class ManageBrand {
	private static ManageBrand manageBrandPage;
	...
	public static ManageBrand getInstance() {
		if (manageBrandPage == null) {
			manageBrandPage = new ManageBrand();
		}
	...
	public void addEventListener() {
		brandTable.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Brand>() {
			...
			public void changed(ObservableValue<? extends Brand> observable, Brand oldValue, Brand newValue) {
				if (newValue != null) {
					BrandController.setSelectedBrand(newValue);
		...
		updateBrandBtn.setOnMouseClicked(e -> {
			if (!BrandController.isSelectedBrand()) {
			...
			BrandController.updateBrand(BrandController.getSelectedBrand().getBrandID(), brandName);
		...
		deleteBrandBtn.setOnMouseClicked(e -> {
			...
			BrandController.deleteBrand(BrandController.getSelectedBrand().getBrandID());
	...
	public void resetLayout() {
		brandNameTF.setText("");
		BrandController.clearSelectedBrand();;
